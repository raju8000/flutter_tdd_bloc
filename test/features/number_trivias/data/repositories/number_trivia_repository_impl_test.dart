  ...
  group('get concrete number', () {
    ...
    runTestsOnline(() {
      test(
          ...
          () async {
        when(mockRemoteDataSource.getRemoteConcreteNumberTrivia(tNumber))
            .thenAnswer((_) async => tNumberTriviaModel);

        final result = await repository.getConcreteNumberTrivia(tNumber);

        verify(mockRemoteDataSource.getRemoteConcreteNumberTrivia(tNumber));
  ...
  group('get random number', () {
    ...
    runTestsOnline(() {
      test('should return remote data when remote data call is success',
          () async {
        when(mockRemoteDataSource.getRemoteRandomNumberTrivia())
            .thenAnswer((_) async => testNumberTriviaModel);

        final result = await repository.getRandomNumberTrivia();

        verify(mockRemoteDataSource.getRemoteRandomNumberTrivia());
